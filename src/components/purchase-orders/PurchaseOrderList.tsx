                        ...
                        <div className="space-y-2 relative">
                          {flatItem.invoice_images && flatItem.invoice_images.length > 0 && (
                            <img 
                              ...
                              alt="Hóa đơn"
                              className="w-20 h-20 object-cover rounded cursor-pointer transition-transform duration-200 hover:scale-[7] hover:z-50 relative"
                            />
                          )}
                        ...
                        <div className="flex flex-wrap gap-1 justify-end">
                          {priceImages.map((imageUrl, index) => (
                            <img
                              ...
                              src={imageUrl}
                              alt={`Giá mua ${index + 1}`}
                              className="w-8 h-8 object-cover rounded border cursor-pointer transition-transform duration-200 hover:scale-[14] hover:z-50 relative"
                            />
                          ))}
                        </div>
                      ) : (
