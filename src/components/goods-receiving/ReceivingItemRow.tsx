        ...
        <div className="flex gap-3">
          {item.product_images && item.product_images.length > 0 ? (
            <img 
              ...
              className="w-20 h-20 object-cover rounded border flex-shrink-0 img-zoom-right-lg"
            />
          ) : (
        ...
        <div className="flex items-center gap-2">
          {item.product_images && item.product_images.length > 0 ? (
            <img 
              src={item.product_images[0]} 
              alt={item.product_name}
              className="w-10 h-10 object-cover rounded border flex-shrink-0 img-zoom-right-lg"
            />
          ) : (
